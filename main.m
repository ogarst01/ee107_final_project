...
if(0)
    ...
    subplot(4, 1, 3);
    [undistorted_srrc_matched_filter_output, ~, ~, ~] = matchedFilter(srrc_modulated, hs_modulated, false);
    ...
    subplot(4, 1, 3);
    [~, ~, undistorted_hs_matched_filter_output, ~] = matchedFilter(srrc_modulated, hs_modulated, false);
